...
public class AudioCue : MonoBehaviour
{
    ...
    public void PlayAudioCue(bool forceToDisableSounds = false)
    {
        _audioCueEventChannel.RaiseEvent(_audioData, _audioSettings, transform.position, forceToDisableSounds);
    }
}
